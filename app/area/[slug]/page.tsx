    ...
    return (
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          {report.nichoImage && <ImgCard title="Composición de ventas por canal" src={report.nichoImage} />}
          {report.top5BestSellersImage && <ImgCard title="Top 5 Mejores Vendedores" src={report.top5BestSellersImage} />}
          {report.top5OverdueCollectionImage && <ImgCard title="Top 5 Recaudo Vencido" src={report.top5OverdueCollectionImage} />}
          </div>
        {report.queVasAHacer && (
